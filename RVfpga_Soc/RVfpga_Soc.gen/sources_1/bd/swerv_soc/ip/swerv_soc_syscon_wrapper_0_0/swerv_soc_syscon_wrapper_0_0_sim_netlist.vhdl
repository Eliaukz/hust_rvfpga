...
-- Date        : Tue Oct 31 19:12:34 2023
-- Host        : LAPTOP-SSK6ALTK running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/Users/R9000X/Desktop/jiekou_lab/lab3/RVfpga_Soc/RVfpga_Soc.gen/sources_1/bd/swerv_soc/ip/swerv_soc_syscon_wrapper_0_0/swerv_soc_syscon_wrapper_0_0_sim_netlist.vhdl
...
architecture STRUCTURE of swerv_soc_syscon_wrapper_0_0_swervolf_syscon is
  ...
  signal \o_wb_rdt[1]_i_1_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of irq_ptc_enable_i_2 : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of \irq_timer_cnt[31]_i_5\ : label is "soft_lutpair12";
  ...
  attribute SOFT_HLUTNM of nmi_int_i_6 : label is "soft_lutpair11";
  ...
  attribute SOFT_HLUTNM of \o_wb_rdt[1]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \o_wb_rdt[1]_i_4\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \o_wb_rdt[31]_i_5\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \o_wb_rdt[4]_i_2\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \o_wb_rdt[4]_i_4\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of sw_irq3_i_3 : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of sw_irq3_i_5 : label is "soft_lutpair11";
...
\o_wb_rdt[0]_i_2\: unisim.vcomponents.LUT5
    generic map(
      ...
      I2 => i_wb_adr(0),
      I3 => i_wb_adr(3),
      I4 => \o_wb_rdt[0]_i_4_n_0\,
      O => \o_wb_rdt[0]_i_2_n_0\
    );
\o_wb_rdt[0]_i_3\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"54105410FFFF0000"
    )
        port map (
      I0 => i_wb_adr(1),
      I1 => i_wb_adr(0),
      I2 => \irq_timer_cnt_reg_n_0_[0]\,
      I3 => \^irq_timer_en_reg_0\,
      I4 => \^p_4_in\(0),
      I5 => i_wb_adr(3),
...
\o_wb_rdt[1]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFF800F8"
    )
        port map (
      I0 => i_wb_adr(3),
      I1 => \o_wb_rdt[1]_i_2_n_0\,
      I2 => \o_wb_rdt[1]_i_3_n_0\,
      I3 => i_wb_adr(2),
      I4 => \o_wb_rdt[1]_i_4_n_0\,
      O => \o_wb_rdt[1]_i_1_n_0\
    );
\o_wb_rdt[1]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"AFA0CFCFAFA0C0C0"
    )
        port map (
...
\o_wb_rdt[1]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"4044"
    )
        port map (
...
\o_wb_rdt[1]_i_4\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"1010FF00"
    )
        port map (
...
entity swerv_soc_syscon_wrapper_0_0 is
  ...
  attribute X_CORE_INFO of swerv_soc_syscon_wrapper_0_0 : entity is "syscon_wrapper,Vivado 2020.2";
...
architecture STRUCTURE of swerv_soc_syscon_wrapper_0_0 is
  ...
  attribute X_INTERFACE_PARAMETER of i_clk : signal is "XIL_INTERFACENAME i_clk, ASSOCIATED_RESET i_rst, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.000, CLK_DOMAIN swerv_soc_clk_0, INSERT_VIP 0";
